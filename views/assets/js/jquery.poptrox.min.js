...
! function(e) {
    e.fn.poptrox_disableSelection = function() {
        ...
        return u.on("resize orientationchange", function() {
        ...
        }), C.css("cursor", "pointer").on("dblclick", function(e) {
            ...
            e.stopPropagation()
        }), x.css("cursor", "pointer").on("dblclick", function(e) {
